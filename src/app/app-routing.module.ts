...
import { CountryDatailsComponent }  from './country/pages/country-datails/country-datails.component';
...
const routes: Routes = [
    ...
    {
        path:'country/:countryIdCode',
        component:CountryDatailsComponent
    },
    {   
        path:'**',
        redirectTo: ''
